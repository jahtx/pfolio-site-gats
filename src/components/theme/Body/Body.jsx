...
const Body = () => {
  return (
    <div className="container-lg j-common">
      <h1>
        James Alvarado Hernandez is a Product & Services UX Designer, Front-end
        Engineer, and breakfast taco aficionado.
      </h1>
      <p>
        Ally for accessibility and inclusiveness. Applications should always be
        created and maintained for a comprehensive audience. Everyone is
        invited! 🥳
      </p>
      <p>
        Applications should apply the best new technologies where they enhance
        maintainability and function. Angular and React are excellent tools, but
      ...
      <p>
        ...
        demonstration of best UX outcomes given project constraints and budgets.
      </p>
    </div>
  )
}
